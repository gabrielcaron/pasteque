<section class="stepleft__section">
    ...
    <section class="">
        ...
        <section id="sectionPaiementFacturation" class="stepleft__sectionForm">
                ...
                <div class="stepleft__champFlex">
                    <div class="stepleft__champFlex--item">
                        ...
                        <select class=" formulaire__champInputExp" id="facturation_moisExpiration" name="facturation_moisExpiration">
                            ...
                            <option value="1" @if($paiement !== null && $paiement->getMoisExpiration() === 1) selected @endif>01</option>
                            <option value="2" @if($paiement !== null && $paiement->getMoisExpiration() === 2) selected @endif>02</option>
                            <option value="3" @if($paiement !== null && $paiement->getMoisExpiration() === 3) selected @endif>03</option>
                            <option value="4" @if($paiement !== null && $paiement->getMoisExpiration() === 4) selected @endif>04</option>
                            <option value="5" @if($paiement !== null && $paiement->getMoisExpiration() === 5) selected @endif>05</option>
                            <option value="6" @if($paiement !== null && $paiement->getMoisExpiration() === 6) selected @endif>06</option>
                            <option value="7" @if($paiement !== null && $paiement->getMoisExpiration() === 7) selected @endif>07</option>
                            <option value="8" @if($paiement !== null && $paiement->getMoisExpiration() === 8) selected @endif>08</option>
                            <option value="9" @if($paiement !== null && $paiement->getMoisExpiration() === 9) selected @endif>09</option>
