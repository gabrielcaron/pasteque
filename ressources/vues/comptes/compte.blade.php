                    ...
                    <form id="form" name="inscription" class="form" method="POST" action="#">
                        ...
                        <div id="champPseudonyme" class="champ champ--lg">
                            <div class="champ__boite">
                                <label for="pseudonyme" class="champ__etiquette">Entrez votre pseudonyme</label>
                                <input class="champ__input" id="pseudonyme" name="pseudonyme" type="text"
                                       autocomplete="pseudonyme" required="required"
                                       aria-labelledby="messagesPseudonyme"
                    ...
                    <form id="form" name="inscription" class="form" method="POST" action="#">
                        ...
                        <div id="champPseudonyme" class="champ champ--lg">
                            ...
                            <div id="messagesPseudonyme" class="champ__messages">
                                ...
                                <p class="champ__message-aide">
                                    ...
                                    Utiliser&nbsp;des&nbsp;lettres,&nbsp;des&nbsp;traits&nbsp;d'union&nbsp;ou&nbsp;le&nbsp;tiret&nbsp;bas&nbsp;pour&nbsp;
                                    composer&nbsp;votre&nbsp;pseudonyme.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="emailflex">
                            ...
                            <div id="champEmailConfirmation" class="champ champ--lg">
                                <div class="champ__boite">
                                    <label for="emailConfirmation" class="champ__etiquette">Confirmation du
                                        courriel</label>
                                    <input class="champ__input" id="emailConfirmation" name="emailConfirmation"
                        ...
                        <div id="champMdpConfirmation" class="champ champ--lg">
                            <div class="champ__boite">
                                <label for="mdpConfirmation" class="champ__etiquette">Veuillez confirmer votre mot de passe</label>
